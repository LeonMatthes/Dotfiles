...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="leon"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/leon/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/leon/.mailcheckrc"
# }
