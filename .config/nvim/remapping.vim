...
nnoremap <Tab>H :tabmove -1<CR>
nnoremap <Tab>J :tabmove 0<CR>
nnoremap <Tab>K :tabmove<CR>
nnoremap <Tab>L :tabmove +1<CR>

for tabpageindex in range(1,&tabpagemax)
  execute 'nnoremap <Tab>' . tabpageindex . ' ' . tabpageindex . 'gt'
endfor
